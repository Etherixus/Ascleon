...
|------|--------|-------------------|
| Software Engineer | Eric Choi | Control logic, AI, sensors, voice, integration |
| Mechanical Engineer | Christian Chillemi | Soft body design, actuators, frame, sensors mounting |
...
│   ├── CAD/            # 3D models for fabrication
│   ├── wiring/         # Wiring diagrams, schematics
│   └── BOM.md          # Bill of Materials
│
├── software/           # Source code for all software systems
│   ├── sensors/
│   ├── movement/
│   ├── voice/
│   ├── personality/
